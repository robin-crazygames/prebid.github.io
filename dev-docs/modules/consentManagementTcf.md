...
| gdpr.defaultLegalBasis | `object` | Legal basis to use when it cannot be determined from on a vendor's GVL declaration. | `{purposes: [1,2,4,7], flexiblePurposes: [2], legIntPurposes: [], specialFeatures: [1]}` |
